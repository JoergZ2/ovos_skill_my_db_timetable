...
SKILL_CLAZZ = "My_DB_Timetable_Skill"  # Make sure it matches __init__.py class name
VERSION = "0.0.1"
URL = "https://github.com/JoergZ2/ovos-skill-my-db-timetable"
AUTHOR = "JoergZ2"
EMAIL = ""
LICENSE = "Apache2.0"
DESCRIPTION = "Skill for using Deutsche Bahn timetable API"
